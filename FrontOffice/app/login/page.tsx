    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4">
      ...
      <Card className="relative z-10 w-full max-w-md border-purple-500/20 bg-gray-900/50 backdrop-blur-xl">
        <CardHeader className="space-y-1 text-center">
          ...
          <CardDescription className="text-purple-200/70">Sign in to continue creating amazing art</CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-gray-900/50 text-purple-300">Or continue with</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button
              ...
              className="bg-gray-900/50 border-purple-500/30 text-purple-100 hover:bg-gray-800/50 hover:text-white"
            >
